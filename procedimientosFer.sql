...
create procedure if not exists obtener_academicos_campos (
...
create procedure if not exists registrar_cuenta (
    in p_idPersona int,
...
create procedure if not exists obtener_colaboracion_academicos (
...
create procedure if not exists obtener_estudiantes_colaboracion (
...
create procedure if not exists obtener_academicos_colaboracion (
    in p_idColaboracion int
)
begin
    select a.*
