...
CREATE USER IF NOT EXISTS "admin_COIL"@"192.168.125.31" IDENTIFIED BY "habitacionDeVuelo";

GRANT INSERT, SELECT, EXECUTE, UPDATE, DELETE ON COIL.* TO "admin_COIL"@"192.168.125.31";

CREATE USER IF NOT EXISTS "admin_COIL2"@"192.168.125.76" IDENTIFIED BY "habitacionDeVuelo";

GRANT INSERT, SELECT, EXECUTE, UPDATE, DELETE ON COIL.* TO "admin_COIL2"@"192.168.125.76";
