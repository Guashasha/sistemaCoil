...
public class AyudantePruebasColaboracionDB {
    ...
    public static void agregarColaboracionesParaRetroalimentacion () {
        ConfiguracionPrueba.ejecutarInstruccionSQL("INSERT INTO colaboracion (estado, tipo, temaInteres, idioma, objetivo, fechaInicio, fechaFin, perfilEstudiante) VALUES ('enRevision', 'COIl', 'Desarrollo web', 'Inglés', 'Crear un proyecto conjunto', '2024-04-15', '2024-07-15', 'Estudiantes de ingeniería de software');");
        ConfiguracionPrueba.ejecutarInstruccionSQL("INSERT INTO colaboracion (estado, tipo, temaInteres, idioma, objetivo, fechaInicio, fechaFin, perfilEstudiante) VALUES ('enRevision', 'COIl', 'Desarrollo no web', 'español', 'Crear un proyecto conjunto', '2024-04-15', '2024-07-15', 'Estudiantes de ingeniería de software');");
        ConfiguracionPrueba.ejecutarInstruccionSQL("INSERT INTO academicoDesarrolla (idColaboracion, idAcademico, estado) VALUES (5, '200011', 'anfitrion')");
        ConfiguracionPrueba.ejecutarInstruccionSQL("INSERT INTO academicoDesarrolla (idColaboracion, idAcademico, estado) VALUES (6, '123', 'anfitrion')");
    }
