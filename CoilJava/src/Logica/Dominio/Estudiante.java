...
public class Estudiante extends Persona {
    ...
    public boolean equals (Object obj) {
        ...
        if (this == obj) {
            ...
            igual = this.getIdPersona() == estudiante.getIdPersona() && this.getNombre().equals(estudiante.getNombre()) &&
                    this.getApellidoPaterno().equals(estudiante.getApellidoPaterno()) && this.getApellidoMaterno().equals(estudiante.getApellidoMaterno()) &&
                    this.getIdUniversidad() == estudiante.getIdUniversidad() && this.idEstudiante == estudiante.getIdEstudiante() &&
                    this.matricula.equals(estudiante.getMatricula()) ? true:false;
        }
        return igual;
    }
