    ...
    private void checarNombre (String nombre) {
        ...
        if (!matcher.matches()) {
            throw new IllegalArgumentException("""
                                                       ...
                                                       4. Su longitud debe ser máximo 20 caracteres.""");
        }
    }
    private void checarApellido (String apellido) {
        String apellidosRegex = "^[A-Za-záéíóúÁÉÍÓÚñÑ][A-Za-záéíóúÁÉÍÓÚñÑ\\\\s]{0,48}[A-Za-záéíóúÁÉÍÓÚñÑ]$";
        ...
        if (!matcher.matches()) {
            throw new IllegalArgumentException("""
                                                       ...
                                                       2. Su longitud debe ser máximo 20 caracteres""");
        }
    }
